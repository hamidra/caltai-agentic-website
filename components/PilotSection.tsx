        ...
        <section className="relative w-full min-h-screen flex flex-col items-center justify-start px-8 md:pl-20 md:pr-[120px] pt-[142px] pb-16 bg-grid">
            <div className="max-w-7xl w-full text-left">
                ...
                <motion.div
                    ...
                    className="bg-card-bg backdrop-blur-sm border border-card-border rounded-[40px] p-12 md:p-20 shadow-sm relative overflow-hidden"
                >
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
                        {steps.map((step, index) => (
                            <div key={index} className="flex flex-col items-center text-center flex-1">
                                ...
                                <h3 className="text-2xl font-bold text-secondary mb-3 font-cal">
                                    {step.title}
                                </h3>
                                <p className="text-muted text-[17px] leading-relaxed max-w-[200px]">
                                    {step.description}
                                </p>

                                {index < steps.length - 1 && (
                                    <div className="hidden md:block absolute top-12 left-[33.33%] translate-x-12">
                                        <svg width="40" height="24" viewBox="0 0 40 24" fill="none" className="text-border-strong">
