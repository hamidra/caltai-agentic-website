    ...
    <section className="relative bg-[#FBF9F4]">
      <div className="page-frame flex min-h-[560px] flex-col md:min-h-[640px] lg:min-h-[720px]">
        ...
        <div className="relative flex min-h-[170px] items-center justify-center overflow-hidden bg-[#F6F3EF] px-5 py-10 sm:px-6 md:px-10 lg:h-[155px] lg:px-[55px] lg:py-0">
          ...
          {/* Large Icon, desktop only to avoid overlap */}
          <div className="pointer-events-none absolute left-[155px] top-1/2 hidden -translate-y-1/2 text-[#5C35F5] opacity-80 lg:block">
          ...
          {/* Small Icon, desktop only to avoid overlap */}
          <div className="pointer-events-none absolute right-[155px] top-1/2 hidden -translate-y-1/2 text-[#5C35F5] opacity-80 lg:block">
            <svg width="55" height="60" viewBox="0 0 46 50" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g opacity="0.65">
                ...
                <line x1="1.5" y1="-1.5" x2="4.68131" y2="-1.5" transform="matrix(-0.0534642 -0.99857 -0.99857 0.0534642 16.3906 8.1582)" stroke="#7056D6" strokeWidth="3" strokeLinecap="round" />
                <line x1="1.5" y1="-1.5" x2="6.09465" y2="-1.5" transform="matrix(-0.768046 -0.640395 -0.640395 0.768046 7.57812 12.4785)" stroke="#7056D6" strokeWidth="3" strokeLinecap="round" />
                <line x1="1.5" y1="-1.5" x2="6.02349" y2="-1.5" transform="matrix(-0.999054 0.0434936 0.0434936 0.999054 7.79688 21.4199)" stroke="#7056D6" strokeWidth="3" strokeLinecap="round" />
              </g>
            </svg>
          </div>
        </div>
