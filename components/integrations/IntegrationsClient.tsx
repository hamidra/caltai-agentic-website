...
const workflowExamples = [
    ...
    },
    {
        ...
        text: "A lead enters the CRM, CaltAI enriches context, drafts follow-up, updates status, prepares meeting notes, and keeps the opportunity from going stale.",
        tools: ["HubSpot", "Apollo", "Gmail", "Google Calendar", "Slack"],
    },
    {
        title: "Outbound follow-up",
        text: "A prospect replies, clicks, books, or goes silent. CaltAI updates the record, drafts the next step, routes approval when needed, and keeps the account moving.",
        tools: ["HubSpot", "Apollo", "Clay", "Gmail", "Calendly"],
    },
];
...
const IntegrationLogo = ({ name, logoText }: { name: string; logoText: string }) => (
    <div
        aria-label={`${name} logo`}
        className="flex h-[42px] w-[42px] shrink-0 items-center justify-center rounded-[12px] border border-[#D5D4CF] bg-[#FBF9F4] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.5)]"
    >
        <span className="font-sans text-[13px] font-bold tracking-[-0.02em] text-[#443218]">
            {logoText}
        </span>
    </div>
);
...
export default function IntegrationsClient() {
    ...
    const currentCount = filteredIntegrations.length;
        ...
        <main className="bg-[#FBF9F4] text-[#443218]">
            ...
            <section className="relative bg-[#FBF9F4]">
                <div className="page-frame">
                    ...
                    <header className="px-6 pb-14 pt-16 md:px-10 md:pb-18 md:pt-20 lg:px-[55px] lg:pb-[80px] lg:pt-[82px]">
                    ...
                    <section className="px-6 py-7 bg-[#F6F3EF] md:px-10 lg:px-[55px]">
                                ...
                                return (
                                    <button
                                        ...
                                        className={`h-[32px] rounded-full border px-4 font-sans text-[13px] font-medium transition-colors ${isActive
                                            ? "border-[#FF5A1F] bg-[#FF5A1F] text-white"
                                            : "border-[#D5D4CF] bg-[#h-[36px] rounded-full border px-4 font-sans text-[14px]] text-[#695A44] hover:border-[#FF5A1F] hover:text-[#FF5A1F]"
                                            }`}
                                    >
                                        {category}
                                    </button>
                                ...
                                <article key={integration.name}>
                                    ...
                                    >
                                        <div className="flex items-start justify-between gap-4">
                                            <IntegrationLogo name={integration.name} logoText={integration.logoText} />
