    ...
    return (
        <footer className="relative bg-[#242424] text-[#F2EEE9]">
            <div className="page-frame page-frame-dark border-t border-[#4A4A4A]">
                <div className="grid grid-cols-1 gap-12 px-5 py-12 sm:px-6 md:px-8 lg:grid-cols-[1fr_520px] lg:gap-[90px] lg:px-[55px] lg:py-[58px]">
                    <div>
                        <Link href="/" aria-label="CaltAI home" className="inline-flex">
                            <svg
                                ...
                                className="h-[68px] w-auto md:h-[78px] lg:h-[86px]"
                            >
                                <path d="M71.7932 27.6128C60.0758 27.6128 48.8385 32.2676 40.553 40.553C32.2676 48.8385 27.6128 60.0758 27.6128 71.7932C27.6128 83.5106 32.2676 94.7479 40.553 103.033C48.8385 111.319 60.0758 115.974 71.7932 115.974V143.586C52.7525 143.586 34.4916 136.022 21.0278 122.559C7.56394 109.095 -2.07166e-09 90.8339 0 71.7932C1.43754e-06 52.7525 7.56394 34.4916 21.0278 21.0278C34.4916 7.56394 52.7525 0 71.7932 0V27.6128Z" fill="#FA9063" />
                                <path d="M99.4135 0C99.4135 5.8018 100.556 11.5467 102.777 16.9069C104.997 22.2671 108.251 27.1376 112.354 31.2402C116.456 35.3427 121.327 38.597 126.687 40.8173C132.047 43.0375 137.792 44.1804 143.594 44.1804V71.7932C124.553 71.7932 106.292 64.2293 92.8286 50.7654C79.3647 37.3016 71.8008 19.0407 71.8008 0H99.4135Z" fill="#F8B89E" />
                                <path d="M171.207 143.587H143.594V99.4067C137.792 99.4067 132.047 100.55 126.687 102.77C121.327 104.99 116.456 108.244 112.354 112.347C108.251 116.449 104.997 121.32 102.777 126.68C100.556 132.04 99.4135 137.785 99.4135 143.587H71.8008C71.8008 124.546 79.3647 106.286 92.8285 92.8217C106.292 79.3579 124.553 71.7939 143.594 71.7939H171.207V143.587Z" fill="#FC9E75" />
                                <path d="M143.602 27.6172H171.214V44.1848H143.602V27.6172Z" fill="#F8CDBA" />
                            </svg>
                        </Link>

                        <p className="mt-5 max-w-[430px] font-inter text-[15px] font-normal leading-[1.6] text-[#D7C1A4] md:text-[16px]">
                            An operation system that runs client onboarding, follow-up, intake,
                            and lifecycle work across your tools.
                        </p>
                    </div>

                    <div className="grid grid-cols-1 gap-9 font-inter sm:grid-cols-3 sm:gap-8 lg:gap-[56px]">
                        {groups.map((group) => (
                            <div key={group.title}>
